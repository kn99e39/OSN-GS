# Worklog 120 — Ordered Boundary to Boundary-first Visible NURBS Materialization Adapter

## 상태

완료(실험적 adapter 범위). Worklog 119의 review-only ordered boundary component를 admissibility 검토 후 canonical `TorchNURBSSurface`로 materialize하는 adapter를 추가했다.
