# Worklog 132 — Mode-Aware Representative Selection Phase 2 Exact 최적화

## 목표

Worklog 131 이후 남은 mode-aware representative selection 병목을 줄인다. cell mode splitting, stable-ID 순서, FPS 정책은 고정하며, v3 replay artifact의 candidate 및 FPS trace와 완전히 일치하는 구현만 채택한다.
