...
# OSN-GS Worklog 120 diagnostic-only build (Candidate D, arbitrary-query-depth
# probe of canonical traversal). A sibling of
...
setup(
    name="diff_surfel_rasterization_qdepth",
    packages=['diff_surfel_rasterization_qdepth'],
    version='0.0.1',
    ext_modules=[
        CUDAExtension(
            name="diff_surfel_rasterization_qdepth._C",
            sources=[
